...
if __name__ == '__main__':
    ...
    model = net.Net(net_info["continuous_dim"], net_info["categorical_dim"], net_info["output_dim"], net_info["hidden_dim"], net_info["conv_depth"], train_info["mode"], graph_info["k"], nn.Tanh()).to(device)
